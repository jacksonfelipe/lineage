...
CKEDITOR_ALLOW_NONIMAGE_FILES = False   # Apenas imagens
CKEDITOR_RESTRICT_BY_USER = True        # Cada usuário vê/apenas envia seus próprios arquivos
CKEDITOR_RESTRICT_BY_DATE = True        # Organiza os uploads por ano/mês/dia
