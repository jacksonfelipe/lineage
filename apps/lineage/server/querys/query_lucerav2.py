        ...
        if is_stackable:
            ...
            try:
                ...
                for i in range(amount):
                    ...
                    union_parts.append(
                        f"SELECT {payment_id}, {owner_id}, {coin_id}, 1, {enchant}, 0, 0, 0, 0, 'DONATE WEB'"
                    )
...
class LineageInflation:
    ...
    Schema: Lucera v2 (usa item_id, item_type, amount, location, obj_Id)
    """
    ...
    def get_all_items_by_location():
        ...
        sql = """
            ...
            ORDER BY i.location, i.item_id, c.char_name
        """
    ...
    def get_items_summary_by_category():
        ...
        sql = """
            SELECT 
                ...
                MIN(i.enchant) AS min_enchant,
                MAX(i.enchant) AS max_enchant,
                AVG(i.enchant) AS avg_enchant
            FROM items i
            INNER JOIN characters c ON c.obj_Id = i.owner_id
            WHERE c.accesslevel = '0'
            AND i.location IN ('INVENTORY', 'WAREHOUSE', 'PAPERDOLL', 'CLANWH')
            GROUP BY i.item_id, i.item_type, i.location
    ...
    def get_top_items_by_quantity(limit=100):
        ...
        sql = """
            ...
            WHERE c.accesslevel = '0'
            AND i.location IN ('INVENTORY', 'WAREHOUSE', 'PAPERDOLL', 'CLANWH')
            GROUP BY i.item_id, i.item_type
